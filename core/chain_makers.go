...
func GenerateChain(config *params.ChainConfig, parent *types.Block, engine consensus.Engine, db ethdb.Database, shyftdb ethdb.SDatabase, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	if config == nil {
...
func makeBlockChain(parent *types.Block, n int, engine consensus.Engine, db ethdb.Database, shyftdb ethdb.SDatabase, seed int) []*types.Block {
	blocks, _ := GenerateChain(params.TestChainConfig, parent, engine, db, shyftdb, n, func(i int, b *BlockGen) {
