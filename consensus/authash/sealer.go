...
func (ethash *Authash) Seal(chain consensus.ChainReader, block *types.Block, results chan<- *types.Block, stop <-chan struct{}) error {
...
func (ethash *Authash) mine(block *types.Block, id int, seed uint64, abort chan struct{}, found chan *types.Block) {
...
func (ethash *Authash) remote(notify []string, noverify bool) {
	var (
