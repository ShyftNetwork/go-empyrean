...
var (
	...
	ShyftnetGenesisHash = common.HexToHash("0xa234ce68da0e2567074a1bf3a5be108d71d871da72b4a497e77c970c8f812fbe")
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v Homestead: %v DAO: %v DAOSupport: %v EIP150: %v EIP155: %v EIP158: %v Byzantium: %v Constantinople: %v ConstantinopleFix: %v ShyftNetwork: %v Engine: %v}",
		c.ChainID,
		c.HomesteadBlock,
		c.DAOForkBlock,
		c.DAOForkSupport,
...
// IsShyftNetwork returns whether num is either equal to the ShyftNetwork fork block or greater.
...
type Rules struct {
	...
	IsByzantium, IsConstantinople, IsPetersburg, IsShyftNetwork bool
}
